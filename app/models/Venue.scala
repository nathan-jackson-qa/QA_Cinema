...
case class Venue(id: Int = 0, name: String, address: String, image: String, offers: String, web_address: String, cinema_id: Int)
...
case class Venues(tag: Tag) extends Table[Venue](tag, "venues"){
  ...
  override def * = (id, name, address, image, offers, web_address, cinema_id) <> (Venue.tupled, Venue.unapply)
