...
case class Movie(id: Int, name: String, desc: String, director: String, img_url: String, classification: String)
...
case class Movies(tag: Tag) extends Table[Movie](tag, "movies"){
  ...
  def * = (id, name, desc, director, img_url, classification) <> (Movie.tupled, Movie.unapply)
}
